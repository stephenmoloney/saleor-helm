...
*/}}
{{- define "saleor.name" -}}
{{- default .Chart.Name .Values.saleor.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- if .Values.saleor.fullnameOverride -}}
{{- .Values.saleor.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.saleor.nameOverride -}}
